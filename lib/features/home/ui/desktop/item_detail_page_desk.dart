...
import 'house_property_widget_desk.dart';
                ...
                children: <Widget>[
                  CarouselSlider(
                    options: CarouselOptions(
                      ...
                      initialPage: widget.imgPathIndex
                    ),
                    items: Constants.imageList.map((item) => Center( child: Image.asset(item, fit: BoxFit.fitWidth, height: screenHeight))).toList(),
                  ),
                  Padding(
                    ...
                    child: Row(
                      ...
                      children: <Widget>[
                        ...
                        CustomButtonWidget(
                          ...
                          iconColor: widget.house.isFavorite ? Colors.redAccent : Colors.black,
                          backgroundColor: Colors.transparent,
                          onBtnTap: () {
